...
df = pd.DataFrame(pd.read_excel(r'data\50P8N.xlsx', 'patients'))  # patient data
df_n = pd.DataFrame(pd.read_excel(r'data\50P8N.xlsx', 'nurses'))  # nurse data
...
bigM = 100000  # infinitely large number
